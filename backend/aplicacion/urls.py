...
router.register(r'comentarios-tutoriales', ComentarioTutorialViewSet, basename='comentarios_tutoriales')
...
urlpatterns = [
    ...
    path('usuario/me/', usuario_actual),
